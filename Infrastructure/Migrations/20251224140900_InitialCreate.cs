        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaInSquareKm = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_CountryId_IsCapital",
                table: "Cities",
                columns: new[] { "CountryId", "IsCapital" },
                filter: "[IsCapital] = 1 AND [IsDeleted] = 0");
